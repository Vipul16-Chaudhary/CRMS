...
{
    public class WebApiResponseFunction
    {
        public WebApiResponseFunction() { }
        ...
        public async static Task<ResponseInfo<T>> PostResponseFromWebAPIFromBody<T>(string baseUrl, string webApiMethod, string token, string key, JObject inputParams)
        {
            ResponseInfo<T> responseInfo = new ResponseInfo<T>();
            HttpResponseMessage response = null;
            try
